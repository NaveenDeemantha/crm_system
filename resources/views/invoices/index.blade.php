...
<div class="container mx-auto px-4 py-8">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <a href="{{ route('invoices.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center w-full sm:w-auto justify-center">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex justify-between items-start mb-2">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">LKR {{ number_format($invoice->amount, 2) }}</p>
                        <p class="text-sm text-gray-500">Due: {{ $invoice->due_date->format('Y-m-d') }}</p>
                    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($invoices as $invoice)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">LKR {{ number_format($invoice->amount, 2) }}</td>
